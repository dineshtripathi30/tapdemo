...
┃ ┃ ┃ ┃ ┃ Debug accelerator-log.md didn't match [config/*.yaml, Tiltfile, README.md, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug catalog-info.yaml didn't match [config/*.yaml, Tiltfile, README.md, catalog/*.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tapdemo]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->tanzudemoreg.azurecr...(truncated)]
